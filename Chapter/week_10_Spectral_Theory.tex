...
\begin{proof}
  ...
  \end{center}
   ...
   Hence $(u_k)$ is Cauchy and $u_k\to u$ for some $u\in H$. But $A=\dual{A}$ has a closed graph so $v=(\zeta-A)u$, i.e. (**) holds.\\ \todo{Is A a bounded operator?(unless A is defined everywhere)}
		Back to (*):\\
