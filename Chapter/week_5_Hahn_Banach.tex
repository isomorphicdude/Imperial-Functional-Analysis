...
\end{align*}
where in the last step we used the "$\leq$" direction in the proof of \Cref{dualilty of norm} holds and the supremum over $\dual{y}$ is attained by \Cref{existence of functional equals norm squared}.  
\end{proof}
