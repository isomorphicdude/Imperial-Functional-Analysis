...
% \todo{Should we delete this section? ZY.}
...
\begin{proposition}[Metric induced by norm]\rm\nextline
	Let $\norm{\cdot}$ be a norm on $V$, then its induced metric $\rho(x,y)=\norm{x-y}$ is translation invariant. %See definition of norm {\color{red} \href[definition of norm]{here}}.
\end{proposition}
...
% Following parts causes bug, why?
